...
exports._PVN = [ '百葉窗', 'jzShutter', 'v0.2.0' ];
...
function jzShutter(){
    ...
    i.shutter = function(){
        ...
        jClone( i.shutter.factory, {
            move: ion_move,
            vision: ion_vision,
            cue: ion_cue,
            actMoveFunc: ion_actMoveFunc,
            timer: ion_timer
        } );
        ...
        delete this.shutter;
        ion_shutter = ion_clear = ion_factory = ion_move = ion_vision = ion_cue = null;
    };
    ...
    function ion_shutter( HElemMain ){
        ...
        //Cue 提示點函數
        if( jArgu.HElemCue && jCueFuncName in ion_cue ){
